...
(defn run
  ...
  (print (string
    ...
    (project/register)
    "\n"
    "echo -debug 'ok: keybindings registered'\n"
    ...
    "  if [ -f \"$cfg\" ]; then\n"
    "    printf \"echo -debug 'ok: sourcing user config at %s'\\n\" \"$cfg\"\n"
    "    printf \"source '%s'\\n\" \"$cfg\"\n"
    "  else\n"
    "    echo \"echo -debug 'ok: no user config at ~/.config/ok/kakrc'\"\n"
    "  fi\n"
    "}\n"
    "echo -debug 'ok: init complete'\n")))
